...
const GameControls = memo(function GameControls(props: Props) {
    return (
        <div className="gameControls-container">
            ...
            <button className={`gameControls-button ${props.isButton2Active && "gameControls-button-active"}`} onClick={() => props.button2()}><span>{props.button2Value}{props.button2Value == "Call" ? ` (\$${abbreviateChips(props.activeBet - props.playerBet)})`: ""}</span></button>
